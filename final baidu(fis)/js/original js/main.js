$(function() {
    ...
    // 为设置选项和用户选项的子选项绑定鼠标移入和移出事件
    $('#user-list').children().each(function(index, el) {
    ...
    $('#setting-list').children().each(function(index, el) {
        $(this).on('mouseover', function() {
            $(this).css({
                "background-color": "#398BFB",
            })
    ...
    // 为视频区添加hover，出现和消除操作选项
    $('.comic,.movie,.hot_item').hover(function() {
